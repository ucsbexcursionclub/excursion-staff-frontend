    ...
    links: [
        {
            ...
            imageUrl: generateResourceUrl('/resources/icons/qr-code-waiver.png')
        },
        {
            ...
            imageUrl: generateResourceUrl('/resources/icons/GoogleDocsLogo.png')
        },
        {
            ...
            imageUrl: generateResourceUrl('/resources/icons/GoogleSheetsLogo.png')
        },
        {
            title: "Income Form",
            description: "Fill this out after every office hours and general meeting",
            href: "https://forms.gle/uwuQguGCZFpgEjPD8",
            imageUrl: generateResourceUrl('/resources/icons/GoogleFormsLogo.png')
        },
        {
...
export const staffHeads: linkGroupType = {
    ...
    links: [
        ...
        },
        {
            ...
            imageUrl: generateResourceUrl('/resources/icons/GoogleDriveLogo.png')
        },
        {
...
export const tripResources: linkGroupType = {
    ...
    links: [
        ...
        },
        {
            ...
            imageUrl: generateResourceUrl('/resources/icons/GoogleCalendarLogo.png')
        },
        {
            ...
            imageUrl: generateResourceUrl('/resources/icons/AllTrailsLogo.png')
        },
        {
            title: "Surfline Log in",
            description: "username: info@excursionclubucsb.org password: stokestokestoke",
            href: "https://www.surfline.com/",
            imageUrl: generateResourceUrl('/resources/icons/surfline-logo.png')
        },
        {
            title: "SUP Guide",
        ...
        },
        {
            ...
            imageUrl: generateResourceUrl('/resources/icons/GoogleMapsLogo.png')
        },
        {
        ...
        },
        {
            ...
            imageUrl: generateResourceUrl('/resources/icons/FacebookLogo.png')
        },
        {
            ...
            imageUrl: generateResourceUrl('/resources/icons/GooglePhotosLogo.png')
        }
    ]
};
